...
for i in range(len(lst)):
	...
	if stupidbrokendata.shape != (8,):
		...
		new_img = (cv2.inRange(rsz,(240,240,240), (255,255,255))).astype("float64")
		gray = cv2.cvtColor(rsz, cv2.COLOR_BGR2GRAY)*0.25
		new_img += gray
		cv2.imwrite("Data_Training_3/" + lst[i],new_img)
...
for i in range(100):
	...
	kernel = np.ones((20,20),np.float32)/1
